...
from dataset import myFunctional as F
...
def computing_score(model_name, top1, flag, dataset):
    if dataset == "ucf":
        if "slowfast_resnet101" in flag:
