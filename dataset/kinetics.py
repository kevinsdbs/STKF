...
from dataset import myMultiGridHelper as multiGridHelper
from dataset import myVideo_transforms as video_transforms
from dataset import myVolume_transforms as volume_transforms
#  import myVideo_transforms as video_transforms
#  import myVolume_transforms as volume_transforms
class VideoClsDataset(Dataset):
    ...
    def __init__(self, anno_path, data_path, mode='train', clip_len=8,
                 ...
                 use_multigrid=False):
        self.anno_path = anno_path                                      # './kinetics400_attack_samples.csv'
    ...
    def loadvideo_decord(self, sample, clip_ind, sample_rate_scale=1):
        ...
        converted_len = int(self.clip_len * self.frame_sample_rate) # 32*2
        seg_len = len(vr) // self.num_segment                       # 250
